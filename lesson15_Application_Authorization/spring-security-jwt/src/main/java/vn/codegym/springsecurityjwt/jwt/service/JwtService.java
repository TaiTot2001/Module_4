package vn.codegym.springsecurityjwt.jwt.service;
...
@Service  // Đánh dấu đây là service để Spring quản lý và inject khi cần
public class JwtService {
    ...
    // Phương thức lấy Key ký token từ chuỗi SECRET_KEY
