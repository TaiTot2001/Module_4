package vn.codegym.customerlistmanagementapplication;
...
import vn.codegym.customerlistmanagementapplication.service.ipml.SimpleCustomerServiceImpl;

@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "vn.codegym.customerlistmanagementapplication")//load beans --> controllers là các object(beans)
